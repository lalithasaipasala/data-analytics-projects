...
| 📂 Project | 🧰 Tools | 📄 Description |
|------------|----------|----------------|
|⚡[Customer Churn Prediction](https://github.com/lalithasaipasala/Sql_Projects/blob/main/India%20Elections%20Analysis-20250519T163359Z-1-001.zip)  Binary classification project using 100,000 telecom customer records to predict churn. Compared scikit-learn and PySpark MLlib implementations, evaluating accuracy, training time, and scalability.
|
